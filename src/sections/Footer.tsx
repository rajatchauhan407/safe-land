  ...
  return (
    <FooterContainer>
      ...
      <Grid container spacing={isMobile ? 2 : 4} justifyContent="center">
        ...
        {/* Right Column */}
        <Grid item xs={12} md={6} sx={{ textAlign: isMobile ? 'center' : 'right', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end' }}>
          <Typography variant="body2">
            <NavItem href="#">Home</NavItem>
            <NavItem href="#">How it works</NavItem>
            <NavItem href="#">Meet the team</NavItem>
          </Typography>   
          <div style={{ textAlign: isMobile ? 'center' : 'right', display: 'flex', justifyContent: isMobile ? "center" : "flex-end", alignItems: 'center' }}>
            <Typography variant="body2" sx={{ marginRight: '10px' }}>Powered by</Typography>
            <Image src={logoTechTribe} alt="Tech Tribe Logo" width={100} height={100} />
          </div>
        </Grid>
      </Grid>
      </Box>
